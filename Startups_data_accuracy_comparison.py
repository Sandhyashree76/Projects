# -*- coding: utf-8 -*-
"""
Created on Mon Aug  8 09:57:24 2022

@author: sc229
"""

import pandas as pd
data=pd.read_csv("C:/sandhyashree/DS/ML&AI/Practice/New folder/50_Startups-1.csv")
print(data.isna().sum())
...
plt.plot(data['Profit'],data['Administration'],label='Administration')
plt.plot(data['Profit'],data['Marketing Spend'],label='Marketing Spend')
plt.plot(data['Profit'],data['State'],label='State')
plt.xlabel("Spend")
plt.ylabel("Profit")
plt.legend()
plt.show()
